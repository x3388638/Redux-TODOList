...
/***/ function(module, exports, __webpack_require__) {
	...
	var App = function (_) {
		...
		function render() {
			...
			var yetNum = 0;
			// set filter
			$('.filterWrap').find('.filter').removeClass('active').end().find('.filter.btn-' + state.visibility).addClass('active');
	
			// update list
			$('#listWrap ul').html('');
			state.tasks.forEach(function (val, i) {
				if (val.isDone) {
					doneNum++;
				} else {
					yetNum++;
	...
	App.render();
	_TaskInput2.default.init(App.store);
	_TodoList2.default.init(App.store);
	_Filter2.default.init(App.store);
...
/***/ function(module, exports) {
	...
	var TaskInput = function (_) {
		...
		function _bindEvent() {
			$inputWrap.off('click.addTask').on('click.addTask', '#btn-addTask', _handleAddTask);
			$inputWrap.off('keypress.addTask').on('keypress.addTask', '#addTaskInput', _handleKeypress);
		}
...
/***/ function(module, exports) {
	...
	var Filter = function (_) {
		...
		function _bindEvent() {
			$filterWrap.off('click.setFilter').on('click.setFilter', '.filter', _handleSetFilter);
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "#statusWrap {\n\tmargin-top: 50px;\n}\n#listWrap {\n\tmargin-top: 20px;\n}\n#listWrap .task .taskStatus {\n\tborder: 1px solid #CCC;\n\tborder-radius: 25px;\n\tcolor: green;\n\tmargin-right: 10px;\n\tcursor: pointer;\n\twidth: 28.02px;\n\theight: 28px;\n\tdisplay: inline-block;\n\ttext-align: center;\n\tline-height: 28px;\n\tvertical-align: middle;\n}\n#listWrap .task .taskStatus.yet .glyphicon {\n\tdisplay: none;\n}\n#listWrap .task .btn-delTask {\n\tcolor: #FF6F6F;\n\tcursor: pointer;\n\tdisplay: none;\n}\n#listWrap .task .btn-delTask:hover {\n\tcolor: #FF0000;\n}\n#listWrap .task:hover .btn-delTask {\n\tdisplay: initial;\n}", "", {"version":3,"sources":["/./static/css/style.css"],"names":[],"mappings":"AAAA;CACC,iBAAiB;CACjB;AACD;CACC,iBAAiB;CACjB;AACD;CACC,uBAAuB;CACvB,oBAAoB;CACpB,aAAa;CACb,mBAAmB;CACnB,gBAAgB;CAChB,eAAe;CACf,aAAa;CACb,sBAAsB;CACtB,mBAAmB;CACnB,kBAAkB;CAClB,uBAAuB;CACvB;AACD;CACC,cAAc;CACd;AACD;CACC,eAAe;CACf,gBAAgB;CAChB,cAAc;CACd;AACD;CACC,eAAe;CACf;AACD;CACC,iBAAiB;CACjB","file":"style.css","sourcesContent":["#statusWrap {\n\tmargin-top: 50px;\n}\n#listWrap {\n\tmargin-top: 20px;\n}\n#listWrap .task .taskStatus {\n\tborder: 1px solid #CCC;\n\tborder-radius: 25px;\n\tcolor: green;\n\tmargin-right: 10px;\n\tcursor: pointer;\n\twidth: 28.02px;\n\theight: 28px;\n\tdisplay: inline-block;\n\ttext-align: center;\n\tline-height: 28px;\n\tvertical-align: middle;\n}\n#listWrap .task .taskStatus.yet .glyphicon {\n\tdisplay: none;\n}\n#listWrap .task .btn-delTask {\n\tcolor: #FF6F6F;\n\tcursor: pointer;\n\tdisplay: none;\n}\n#listWrap .task .btn-delTask:hover {\n\tcolor: #FF0000;\n}\n#listWrap .task:hover .btn-delTask {\n\tdisplay: initial;\n}"],"sourceRoot":"webpack://"}]);
